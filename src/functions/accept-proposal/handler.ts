...
import { acceptProposalController } from '../../modules/poke-trading/useCases/acceptProposal'

import schema from './schema';

const handler: ValidatedEventAPIGatewayProxyEvent<typeof schema> = async (event) => await acceptProposalController.execute(event)
